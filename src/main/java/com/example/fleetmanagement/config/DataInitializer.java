    ...
    CommandLineRunner initDatabase() {
        ...
        return args -> {
            ...
            packageRepository.saveAll(List.of(
                    ...
                    new Package("P8988000122", DeliveryPoint.DISTRIBUTION_CENTER, ShipmentState.CREATED, 26, sack1),
                    ...
                    new Package("P8988000126", DeliveryPoint.DISTRIBUTION_CENTER, ShipmentState.CREATED, 50, sack1),
                    ...
                    new Package("P9988000128", DeliveryPoint.TRANSFER_CENTER, ShipmentState.CREATED, 55, sack2),
                    new Package("P9988000129", DeliveryPoint.TRANSFER_CENTER, ShipmentState.CREATED, 28, sack2),
